...
class AppSettings(BaseSettings):
    ...
    FOGMOE_OAUTH_ENABLED: bool = False
    FOGMOE_OAUTH_DISCOVERY_URL: str = (
        "https://auth.fog.moe/auth/v1/.well-known/openid-configuration"
    )
    FOGMOE_OAUTH_EXPECTED_ISSUER: str = ""
    FOGMOE_OAUTH_CLIENT_ID: str = ""
    FOGMOE_OAUTH_CLIENT_SECRET: str = ""
    FOGMOE_OAUTH_AUDIENCE: str = ""
    FOGMOE_OAUTH_REDIRECT_URI: str = ""
    FOGMOE_OAUTH_SCOPES: str = "openid email profile"
    FOGMOE_OAUTH_ALLOWED_ALGORITHMS: str = "ES256"
    FOGMOE_OAUTH_LISTEN_HOST: str = "127.0.0.1"
    FOGMOE_OAUTH_LISTEN_PORT: int = Field(default=18765, ge=1, le=65535)
...
AI_ADVISOR_MAX_OUTPUT_TOKENS = SETTINGS.AI_ADVISOR_MAX_OUTPUT_TOKENS
...
FOGMOE_OAUTH_ENABLED = SETTINGS.FOGMOE_OAUTH_ENABLED
FOGMOE_OAUTH_DISCOVERY_URL = SETTINGS.FOGMOE_OAUTH_DISCOVERY_URL
FOGMOE_OAUTH_EXPECTED_ISSUER = SETTINGS.FOGMOE_OAUTH_EXPECTED_ISSUER
FOGMOE_OAUTH_CLIENT_ID = SETTINGS.FOGMOE_OAUTH_CLIENT_ID
FOGMOE_OAUTH_CLIENT_SECRET = SETTINGS.FOGMOE_OAUTH_CLIENT_SECRET
FOGMOE_OAUTH_AUDIENCE = SETTINGS.FOGMOE_OAUTH_AUDIENCE
FOGMOE_OAUTH_REDIRECT_URI = SETTINGS.FOGMOE_OAUTH_REDIRECT_URI
FOGMOE_OAUTH_SCOPES = SETTINGS.FOGMOE_OAUTH_SCOPES
FOGMOE_OAUTH_ALLOWED_ALGORITHMS = SETTINGS.FOGMOE_OAUTH_ALLOWED_ALGORITHMS
FOGMOE_OAUTH_LISTEN_HOST = SETTINGS.FOGMOE_OAUTH_LISTEN_HOST
FOGMOE_OAUTH_LISTEN_PORT = SETTINGS.FOGMOE_OAUTH_LISTEN_PORT
