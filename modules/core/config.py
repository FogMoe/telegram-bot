...
SILICONFLOW_CHAT_MODEL = os.getenv("SILICONFLOW_CHAT_MODEL", "deepseek-ai/DeepSeek-V4-Flash")
SILICONFLOW_SUMMARY_MODEL = os.getenv("SILICONFLOW_SUMMARY_MODEL", "deepseek-ai/DeepSeek-V4-Flash")
SILICONFLOW_TRANSLATE_MODEL = os.getenv("SILICONFLOW_TRANSLATE_MODEL", "deepseek-ai/DeepSeek-V4-Flash")
SILICONFLOW_VISION_MODEL = os.getenv("SILICONFLOW_VISION_MODEL", "deepseek-ai/DeepSeek-V4-Flash")
SILICONFLOW_CLASSIFIER_MODEL = os.getenv("SILICONFLOW_CLASSIFIER_MODEL", "deepseek-ai/DeepSeek-V4-Flash")
